...
| Smart Crop/Tracking، Text Layers، Transitions/Effects | **Not implemented** | لا يوجد تنفيذ أو اختبار لهذه الميزات في هذا الفرع. |
